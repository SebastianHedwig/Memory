  ...
  return /*html*/ `
    <section class="game__exit-overlay" id="game-exit-overlay" data-game-exit-overlay hidden>
      ...
      <div class="game__exit-dialog" role="dialog" aria-modal="true" aria-labelledby="game-exit-title">
        <h3 class="game__exit-title" id="game-exit-title">Are your sure you want to quit the game?</h3>
        <div class="game__exit-actions">
          <button class="game__exit-continue button" type="button" data-action="close-exit-overlay">Back to Game</button>
          <button class="game__exit-confirm button button--secondary" type="button" data-action="exit-game">Exit Game</button>
        </div>
      </div>
    </section>`;
}
